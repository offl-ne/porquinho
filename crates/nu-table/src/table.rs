...
impl<T> From<T> for StyledString
where
    T: ToString,
{
    fn from(other: T) -> Self {
        Self::new(other.to_string(), TextStyle::default())
    }
}
...
impl WrappedTable {
    ...
    fn print_table(&self, color_hm: &HashMap<String, Style>, show_footer: bool) -> String {
        let mut output = String::new();
...
pub fn draw_table(
    ...
    wrapped_table.print_table(color_hm, show_footer)
}
